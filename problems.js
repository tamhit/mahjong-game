...
var PROBLEMS = [
  ...
  },
  {
    ...
    // 待ち: 6索8索→カンチャン（7索）→ツモ
    // 全牌2〜8のみ → タンヤオ成立
    answer: { fu: 40, han: 4, score: { ko: 2600, oya: 5200 } },
    explanation: {
      yaku: ['リーチ: 1翻', '一発: 1翻', '門前清自摸和: 1翻', 'タンヤオ: 1翻'],
      fuBreakdown: [
        '副底: 30',
        '面子（全て順子）: 0',
        '雀頭（5索、役牌なし）: 0',
